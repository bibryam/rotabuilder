...
import com.rotabuilder.dom.solver.move.EmployeeMultipleChangeMove;

public class ShiftAssignmentPillarPartSwapMoveFactory implements MoveListFactory<EmployeeRoster> {
    ...
    public List<Move> createMoveList(EmployeeRoster employeeRoster) {
        ...
        int assignmentSequenceCapacity = employeeRoster.getShiftDateList().size() + 1 / 2;
